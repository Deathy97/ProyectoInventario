...
<div class="wrapper row3">
  <div id="breadcrumb" class="hoc clear"> 
    ...
    <ul>
      ...
      <li><a href="formmarcas.php">Insertar marca</a></li>
...
<?php
  ...
  while($linea=mysqli_fetch_array($registros)){
    echo "<tr><td>$linea[idMarca]</td><td>$linea[Marca]</td><td><a href='bormarcas.php?clave=$linea[idMarca]'><img src='./../imagenes/basura.png'></td></tr>";

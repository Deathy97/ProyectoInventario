...
<table align="center" width="50%" border="1px solid">
  ...
  <tr>
    ...
    <td>
      <input type="date" name="FechaRevision" id="FechaRevision" placeholder="Inserte fecha de la revisión." >
    </td>
  </tr>
  <tr>
    <td>Hora de revisión: </td>
    <td>
      <input type="time" name="hora" id="hora" placeholder="Inserte hora de la revisión.">
    </td>
  </tr>
  <tr>
    <td>Usuario: </td>

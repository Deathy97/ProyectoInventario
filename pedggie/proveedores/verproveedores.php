...
<div class="wrapper row3">
  <div id="breadcrumb" class="hoc clear"> 
    ...
    <ul>
      ...
      <li><a href="formproveedores.php">Insertar proveedor</a></li>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <h1><FIELDSET>CUADRO DE PROVEEDORES</FIELDSET></h1>
...
<?php
  ...
  while($linea=mysqli_fetch_array($registros)){
    echo "<tr><td>$linea[nif]</td><td>$linea[proveedor]</td><td><a href='borproveedores.php?clave=$linea[nif]'><img src='./../imagenes/basura.png' width='25px'></td></tr>";

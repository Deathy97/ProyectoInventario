...
<?php
	...
	while($linea=mysqli_fetch_array($registros)){
		echo "<tr><td>$linea[idSoftware]</td><td>$linea[Descripcion]</td><td>$linea[TipoLicencia]</td><td>$linea[Cantidad]</td><td>$linea[FechaFin]</td><td>$linea[Observaciones]</td><td><a href='borrevisiones.php?clave=$linea[idSoftware]'><img src='imagenes/borrar.png' width='25px'></td></tr>";

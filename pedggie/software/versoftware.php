...
<div class="wrapper row3">
  <div id="breadcrumb" class="hoc clear"> 
    ...
    <ul>
      ...
      <li><a href="formsoftware.php">Insertar software</a></li>
...
<?php
  ...
  while($linea=mysqli_fetch_array($registros)){
    echo "<tr><td>$linea[idSoftware]</td><td>$linea[Descripcion]</td><td>$linea[TipoLicencia]</td><td>$linea[Cantidad]</td><td>$linea[FechaFin]</td><td>$linea[Observaciones]</td><td align='center'><a href='borrevisiones.php?clave=$linea[idSoftware]'><img src='./../imagenes/basura.png'></a></td></tr>";

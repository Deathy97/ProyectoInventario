...
<div class="wrapper row3">
  <div id="breadcrumb" class="hoc clear"> 
    ...
    <ul>
      ...
      <li><a href="formmateriales.php">Insertar material</a></li>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <h1><FIELDSET>CUADRO DE ORDENADORES</FIELDSET></h1>
...
<?php
  include("./../conexion.php");
  $sql = "SELECT idReferencia, Placa, Procesador, Ram, DiscoDuro, Tarjetas, Ip, Dominio FROM ordenadores;";
    mysqli_set_charset($conexion,"utf8");//cuando el campo de la base lleva ñs o cosas raras

  $registros=mysqli_query($conexion, $sql);
  while($linea=mysqli_fetch_array($registros)){
    echo "<tr><td>$linea[idReferencia]</td><td>$linea[Placa]</td><td>$linea[Procesador]</td><td>$linea[Ram]</td><td>$linea[DiscoDuro]</td><td>$linea[Tarjetas]</td><td>$linea[Ip]</td><td>$linea[Dominio]</td><td><a href='bormateriales.php?clave=$linea[idReferencia]'><img src='./../imagenes/basura.png'></td></tr>";

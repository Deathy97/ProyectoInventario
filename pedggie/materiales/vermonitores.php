...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <h1><FIELDSET>CUADRO DE MONITORES</FIELDSET></h1>
...
<?php
  include("./../conexion.php");
  $sql = "SELECT idReferencia, tamaño, tipo FROM monitores;";
    mysqli_set_charset($conexion,"utf8");//cuando el campo de la base lleva ñs o cosas raras

  $registros=mysqli_query($conexion, $sql);
  while($linea=mysqli_fetch_array($registros)){
    echo "<tr><td>$linea[idReferencia]</td><td>$linea[tipo]</td><td>$linea[tamaño]</td><td><a href='bormateriales.php?clave=$linea[idReferencia]'><img src='./../imagenes/basura.png'></td></tr>";

...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <h1><FIELDSET>CUADRO DE IMPRESORAS</FIELDSET></h1>
...
<?php
  include("./../conexion.php");
  $sql = "SELECT i.idReferencia, m.Aparato, i.Tipo, i.Consumible FROM materiales AS m, impresoras as i WHERE m.idReferencia=i.idReferencia;";
  $registros=mysqli_query($conexion, $sql);
  while($linea=mysqli_fetch_array($registros)){
    echo "<tr><td>$linea[idReferencia]</td><td>$linea[Aparato]</td><td>$linea[Tipo]</td><td>$linea[Consumible]</td><td><a href='bormateriales.php?clave=$linea[idReferencia]'><img src='./../imagenes/basura.png'></td></tr>";
